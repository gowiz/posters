...
\begin{columns}
  ...
  \block{Anagrammen}{
    \huge
    \centering
    $P^{^{n_1,n_2,\dots,n_k}}_n = \dfrac{n!}{n_1!\cdot n_2!\cdot \ldots \cdot n_k!}$ \qquad \large of eleganter \qquad \Large   $P_{n_1,\dots,n_k} = \dfrac{\left(\sum_{i=1}^k n_i\right)!}{\prod_{i=1}^k n_i!}$
  }
