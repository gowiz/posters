...
\begin{columns}
    ...
    \begin{minipage}{0.5\linewidth}
      \begin{center}
        \begin{tabular}{c|c|c}
          ...
          \hline
          \xcancel{Volgorde} & Combinatie $C^k_n$                              & Herhalingscombinatie
        \end{tabular}
      \end{center}
    \end{minipage}
  }
  ...
  \note[targetoffsetx=-22cm, targetoffsety=-3cm, angle=90, radius=3cm,
  width=6cm, linewidth=.2cm,
  roundedcorners=20, innersep=1cm]{\centering$P_n=n!$}
  \block{Faculteiten}{
    \Huge
    \begin{align*}
      n!&=n\cdot(n-1)\cdot \cdots \cdot 2\cdot1\\
      0!&=1
    \end{align*}
  }
  ...
  \block{Anagrammen}{
    \huge
    \centering
    $P^{^{n_1,n_2,\dots,n_k}}_n = \dfrac{n!}{n_1!\cdot n_2!\cdot \cdots \cdot n_k!}$ \qquad \large of eleganter\qquad \Large   $P_{n_1,\dots,n_k} = \dfrac{\left(\sum_{i=1}^k n_i\right)!}{\prod_{i=1}^k n_i!}$
  }
